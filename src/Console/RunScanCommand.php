...
class RunScanCommand extends Command
{
    ...
    protected function configure(): void
    {
        ...
        $this->addOption('only', null, InputOption::VALUE_REQUIRED, 'Comma-separated scanners: env,validation,sql,rce,ssrf,deserialize,upload,secrets,cors,redirect,crypto,jwt,api,session,headers,csrf,mass,auth,middleware,xss,dependency,debug');
